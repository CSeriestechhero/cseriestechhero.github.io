...
$(document).ready(function(){
	$(".window").each(function() {      		// window template
		...
		$(this).prepend('<div class="windowHeader"<span>\u2800 </span><strong>' + $(this).attr("data-title") + '</strong><span title="Close" style="line-height:0.65;" class="winclose"><br>&times;</span></div>');
	});
